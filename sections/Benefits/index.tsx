        ...
        <div className="bg-[#005B58] p-10">
            <div className="flex flex-col justify-center">
                <div className="m-auto w-full md:w-1/2 text-center font-bold">
                    <span className="text-[#e97500] text-sm md:text-2xl">
                ...
                <span className="text-[#dfffff] text-center font-extrabold p-8 text-xl md:text-3xl">C$4,000  || N3.5 million </span>
                        ...
                        BenefitData.map((item: BenefitsDataTypes) => (
                            <div key={item.id} className="bg-white p-7 md:p-8 m-auto rounded-[20px]">
                                <div className="flex flex-col justify-center">
                                    ...
                                    <p className="font-bold text-lg md:text-xl text-center mb-3">{item.title}</p>
